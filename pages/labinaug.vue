...
const updateCollege = async (clgid) => {
  try {
    const field = "IS_eLSI";
    const bodyContent = {};
    bodyContent[field] = 1;
    ...
    console.log("error updating college:", e);
  }
};
...
const showTime = () => {
  ...
  if (!isExpanded.value) {
    ...
    collegesStore.setTOeLSICollege();
    // updateCollege(collegesStore.getSelectedCollege);
